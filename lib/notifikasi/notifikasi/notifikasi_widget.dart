...
class _NotifikasiWidgetState extends State<NotifikasiWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<NotifikasiDetailRow>>(
      future: NotifikasiDetailTable().queryRows(
        queryFn: (q) => q
            .eqOrNull(
              'id_user_penerima',
      ...
      builder: (context, snapshot) {
        ...
        List<NotifikasiDetailRow> notifikasiNotifikasiDetailRowList =
            snapshot.data!;
                  ...
                  Builder(
                    builder: (context) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, dataNotifIndex) {
                          ...
                          return Padding(
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  if ((dataNotifIndex == 0) ||
                                      (dataNotifItem.kategoriWaktu !=
                                          notifikasiNotifikasiDetailRowList
                                              .elementAtOrNull(
                                                  dataNotifIndex - 1)
                                              ?.kategoriWaktu))
                                    Padding(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Image.network(
                                                  dataNotifItem.fotoPengirim !=
                                                      ...
                                                      ? dataNotifItem
                                                          .fotoPengirim!
                                                      : 'https://ui-avatars.com/api/?background=random&name=${dataNotifItem.namaPengirim}',
                                                  fit: BoxFit.cover,
                                                ),
                                              ),
                                              if ((dataNotifItem.tipe ==
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      '${dataNotifItem.namaPengirim}${() {
                                                        if (dataNotifItem
                                                                .tipe ==
                                                            'like') {
                                                          return ' menyukai postinganmu';
                                                        } else if (dataNotifItem
                                                                .tipe ==
                                                            'save') {
                                                          return ' menyimpan postinganmu';
                                                        } else {
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(ProfileAdminWidget.routeName);
                                },
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.center,
