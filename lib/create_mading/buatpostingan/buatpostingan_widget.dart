                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FutureBuilder<List<KategoriRow>>(
                                      future: KategoriTable().queryRows(
                                        queryFn: (q) => q,
                                      ),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        ...
                                        return FlutterFlowDropDown<int>(
                                          ...
                                          options: List<int>.from(
                                              dropDownKategoriRowList
                                                  .map((e) => e.id)
                                                  .toList()),
                                          optionLabels: dropDownKategoriRowList
                                      ...
                                      onTap: () async {
                                        await showModalBottomSheet(
                                          ...
                                          builder: (context) {
                                            ...
                                            _model.previewMading = value));

                                        _model.previewPhoto =
                                            _model.previewMading;
                                        safeSetState(() {});
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              await PostinganTable().insert({
                                'judul': _model.textController1.text,
                                'isi': _model.textController2.text,
                                'id_users': FFAppState().loggedInUserId,
                                'id_kategori': _model.dropDownValue,
                                'gambar': _model.previewPhoto,
                              });
