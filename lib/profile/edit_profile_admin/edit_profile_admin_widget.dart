...
class EditProfileAdminWidget extends StatefulWidget {
  ...
  static String routeName = 'EditProfileAdmin';
  static String routePath = '/editProfileAdmin';
                                    ...
                                    onTap: () async {
                                      await showModalBottomSheet(
                                        ...
                                        builder: (context) {
                                          ...
                                          _model.hasilBottomSheet = value));

                                      _model.coverBaru =
                                          _model.hasilBottomSheet;
                                      safeSetState(() {});
