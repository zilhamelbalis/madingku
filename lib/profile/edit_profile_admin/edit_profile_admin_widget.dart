...
class _EditProfileAdminWidgetState extends State<EditProfileAdminWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: 'Badan Eksekutif Mahasiswa');
    ...
    _model.textController3 ??=
        TextEditingController(text: 'bemsttnf@gmail.com');
                            ...
                            Align(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  _model.coverBaru = _model.hasilBottomSheet;
                                  safeSetState(() {});
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (selectedMedia != null &&
                            ...
                            safeSetState(() =>
                                _model.isDataUploading_uploadDataRv5 = true);
                            ...
                            try {
                              ...
                              _model.isDataUploading_uploadDataRv5 = false;
                            }
                            if (selectedUploadedFiles.length ==
                                    selectedMedia.length &&
                                downloadUrls.length == selectedMedia.length) {
                              safeSetState(() {
                                _model.uploadedLocalFile_uploadDataRv5 =
                                    selectedUploadedFiles.first;
                                _model.uploadedFileUrl_uploadDataRv5 =
                                    downloadUrls.first;
                              });
                            } else {
                              safeSetState(() {});
