...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1F41BB);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFFEFB612);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF4F7FE);
  late Color accent1 = const Color(0xFF8B9DFF);
  late Color accent2 = const Color(0xFF4FD1C5);
  late Color accent3 = const Color(0xFFF4B8A8);
  late Color accent4 = const Color(0xFFCBD5E1);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4F6DFF);
