...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: BuatpostinganWidget.routeName,
          path: BuatpostinganWidget.routePath,
          builder: (context, params) => BuatpostinganWidget(),
        ),
        FFRoute(
          name: NotifikasiWidget.routeName,
          path: NotifikasiWidget.routePath,
          builder: (context, params) => NotifikasiWidget(),
        ),
        FFRoute(
          name: ProfileAdminWidget.routeName,
          path: ProfileAdminWidget.routePath,
          builder: (context, params) => ProfileAdminWidget(),
        ),
        FFRoute(
          name: EditProfileAdminWidget.routeName,
          path: EditProfileAdminWidget.routePath,
